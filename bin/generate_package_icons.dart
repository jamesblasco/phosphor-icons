...
String iconDataCode(String hexCode, StyleFileData style) {
  return '''
IconData(
  $hexCode,
  fontFamily: 'Phosphor${style.styleName.capitalize()}',
